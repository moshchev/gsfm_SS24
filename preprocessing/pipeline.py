...
print('initial number of rows ', df_forecast.shape[0])
df_forecast = preprocessing_ibes(df_forecast)
print('number of rows after preprocessing ', df_forecast.shape[0])
print('number of duplicates after preproc ', df_forecast.duplicated().sum())
df_forecast = calculate_pmafe(df_forecast)
print('number of rows after pmafe ', df_forecast.shape[0])
print('number of duplicates after pmafe ', df_forecast.duplicated().sum())
df_forecast = collapse_processed_df(df_forecast)
print('number of rows after collapsig ', df_forecast.shape[0])
print('number of duplicates after collapsig ', df_forecast.duplicated().sum())
df_forecast = analyst_experience(df_forecast)
print('number of rows after analyst experience ', df_forecast.shape[0])
print('number of duplicates after analyst experience ', df_forecast.duplicated().sum())
df_forecast = brokerage(df_forecast)
print('number of rows after brokerage ', df_forecast.shape[0])
print('number of duplicates after brokerage ', df_forecast.duplicated().sum())
df_forecast = sic_codes(df_forecast)
print('number of rows after analyst sic_codes ', df_forecast.shape[0])
print('number of duplicates after sic_codes ', df_forecast.duplicated().sum())
df_forecast = coverage(df_forecast)
print('number of rows after analyst coverage ', df_forecast.shape[0])
print('number of duplicates after coverage ', df_forecast.duplicated().sum())
df_forecast = surprise(df_forecast)
print('number of rows after analyst surprise ', df_forecast.shape[0])
print('number of duplicates after surprise ', df_forecast.duplicated().sum())
